...
r <- read.table("losdos_estadios_escalas_emg5590.csv",header=T,dec=',')
...
n_ratones=length(unique(rr$cod));
 a=MWTKO[[1]][[1]]*0;
...
png(filename="markov_probs_light.png", 
    type="cairo",
    units="in", 
    width=5, 
    height=4, 
